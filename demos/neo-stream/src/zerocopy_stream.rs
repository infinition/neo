//! Zerocopy streaming NVDEC source for neo-stream.
//!
//! Same pattern as neo-mosaic's zerocopy stream: `CaptureMode::Device`
//! with a DtoD hook that copies NV12 planes into interop Y/UV buffers.
