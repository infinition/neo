...
// Neo-FFmpeg patch: NVDEC extern block stripped. The crate's safe layer never
// references these symbols directly — neo-hwaccel provides its own dynamic
// (libloading) bindings to nvcuvid.dll. Keeping the type definitions above
// preserves the ABI for any consumer that wants to use them with their own
// loader.
